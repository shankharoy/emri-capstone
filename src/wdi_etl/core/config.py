...
Usage
-----
    from wdi_etl.core.config import INDICATORS, YEAR_START, YEAR_END
...
# Backward compatibility - re-export at old location
import warnings
...
def __getattr__(name):
    ...
    if name in dir():
        warnings.warn(
            f"Importing {name} from wdi_etl.config is deprecated. "
